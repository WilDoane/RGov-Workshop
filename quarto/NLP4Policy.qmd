...
* fileEncoding: "this file is already using the encoding..."
* encoding: "I want you to re-encode the content to be..."
...
Notice also that read.csv stoped reading the file after the first `t` character. That's because read.csv was likely defaulting to ASCII and encountered bytes `FF FE 74 00` and the `00` NULL byte was assumed to mean END OF FILE.

```{.r}
read.csv(here("data-raw", "plaintext-utf-16-LE.csv"))
```
